...
import { ReactComponent as TapeIcon } from "../../assets/imgs/tape.svg"


function FactoringIs () {
  return (
    <section className="factoring">
      <div className="factoring__inner">
        <div className="factoring__section">
          <div className="factoring__content">
              <h1 className="factoring__header">Что такое факторинг?</h1>
            <div>
              <h2 className="factoring__subtitle">Факторинг
              <TapeIcon className="factoring__tape"/>
              </h2>
            </div>
            <div className="factoring__description">
              <ul className="factoring__definition">
                <li className="factoring__text">это комплекс финансовых улуг, включающий в себя финансирование под уступку денежного требования  к дебиторам, управление дебиторской задолжностью, администрирование документооборота, всесторонний анализ потенциальных и действующих контрагентов.</li>
                </ul>
        ...
        <div className="factoring__section factoring__section_right">
          <div className="factoring__content factoring__content_right">
            <div>
              ...
              <TapeIcon className="factoring__tape factoring__tape_right"/>
              </h2>
            </div>
            <div className="factoring__description factoring__description_right">
              ...
              <p className="factoring__text">Для поставщика - без посещения офиса факториновой компании подавать заявку, предоставлять необходимые документы для получения финансирования, получать необходимые отчеты и закрывающие документы.</p>
              <p className="factoring__text">Для дебитора - получать уведомления об уступке денежнего требования и осуществлять верификацию а режиме on-line.</p>
            </div>
          </div>
        </div>
