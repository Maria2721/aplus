            ...
            <div className="factoring__content factoring__content_left">
              ...
              <div className="factoring__description">
                <ul className="factoring__definition">
                  <li className="factoring__text">это комплекс финансовых улуг, включающий в себя финансирование под уступку денежного требования  к дебиторам, управление дебиторской задолженностью, администрирование документооборота, всесторонний анализ потенциальных и действующих контрагентов.</li>
                </ul>
