            ...
            <div className="contacts__row">
              ...
              <div className="contacts__telAndMail">
                <div className="contacts__linkAndIcon">
                  <TelIcon/> <a href="tel:+74954459099" className="contacts__description">+7 (495) 445-90-99</a>
                </div>
                <div className="contacts__linkAndIcon">
                  <MailIcon/><a href="mailto:info@fcaplus.ru" className="contacts__description">info@fcaplus.ru</a>
                </div>
              </div>
            </div>
          </div>
